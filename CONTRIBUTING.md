...
If you have an idea for a new feature you would like to see added to RedminStore, you may create an issue on GitHub with [Request] in the title. The feature request will then be reviewed by @kongnir.
...
As of RedminStore 0.1.0, we're changing our autoloading standard from PSR-0 to PSR-4 in order to match the same in Laravel 5.1.
...
We're using these tools in our development of RedminStore. It'll help if you use the same tool too.
Please feel free to suggest a better alternative.

* [Laravel Homestead](http://laravel.com/docs/master/homestead) for consistent environment.
